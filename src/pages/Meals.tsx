...
export default function Meals() {
  ...
  useEffect(() => {
    ...
    if (selectedType !== "all") {
      filtered = filtered.filter((m) => m.categoryName.includes(selectedType));
    }
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex justify-end"></div>
              <button
                ...
                className="px-4 py-2 bg-gradient-to-r from-emerald-500 to-teal-600 text-white rounded-xl font-medium hover:from-emerald-600 hover:to-teal-700 transition-all flex justify-between items-center gap-2"
              >
